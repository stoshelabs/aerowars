...
/** {@code /aerowars setup set} — captures the admin's current position for the active step. */
public class SetupSetCommand extends AbstractPlayerCommand {
    private final SetupSessionManager setupManager;

    public SetupSetCommand(@Nonnull AeroWars plugin) {
        super("set", "Definir posição do passo atual");
    ...
    protected void execute(@Nonnull CommandContext context, @Nonnull Store<EntityStore> store,
        ...
        setupManager.handleSet(playerRef);
    }
}
