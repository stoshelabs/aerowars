...
/** {@code /aerowars wand} (admin) — hands the setup wand back (only while in a setup/edit session). */
public class WandCommand extends AbstractPlayerCommand {
    private final AeroWars plugin;

    public WandCommand(@Nonnull AeroWars plugin) {
        super("wand", "Recuperar a varinha de setup (admin)");
        this.plugin = plugin;
    }
    ...
    protected void execute(@Nonnull CommandContext context, @Nonnull Store<EntityStore> store,
        ...
        plugin.getSetupSessionManager().giveWand(playerRef);
    }
}
